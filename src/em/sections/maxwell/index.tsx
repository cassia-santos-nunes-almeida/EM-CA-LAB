...
const CHALLENGE: Challenge = {
  ...
  instructions: [
    `Click each of the four cards in turn — '1. Gauss's Law (E)', '2. Gauss's Law (B)', '3. Faraday's Law', and '4. Ampère-Maxwell' — to expand it, and read the formula and one-line description; note that cards 1 and 2 (the two Gauss laws) contain no time-derivative — they hold at every instant, but alone they cannot couple E and B into a wave.`,
